          ...
          <div class="col-12 row">
            ...
            <div class="col-xs-12 col-sm-auto self-center text-right">
              <div class="col-auto self-center">
                ...
                <!-- <q-btn v-if="!result" flat round dense color="blue" icon="qr_code_scanner" @click="onOpenQRCodeScanner">
                  <q-tooltip v-if="!$q.platform.is.mobile">{{$t('global.qrCodeScanner')}}</q-tooltip>
                </q-btn> -->
        ...
        <template v-slot:body="props">
          <q-tr :props="props">
            ...
            <!-- <q-td key="price" :props="props">
              ...
              <q-popup-edit v-model="props.row.price" :title="$t('product.priceSale')">
              ...
              <q-popup-edit v-model="props.row.priceImport" :title="$t('product.priceImport')" auto-save :validate="v=>parseInt(v)>-1"
                ...
                <template v-slot="scope">
                  <q-input v-model="scope.value" dense autofocus counter class="edit-item no-error-icon no-arrows" @keyup.enter="scope.set"
                    ...
                    <template v-slot:append>
                      <!-- <q-icon name="refresh" class="cursor-pointer" color="teal"
