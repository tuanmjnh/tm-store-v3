<template>
  <q-card flat bordered class="my-card">
    <q-card-section class="row">
      <div class="text-subtitle2 text-bold">{{$t('route.setting')}}</div>
      <q-space />
    ...
    <q-form ref="form">
      <q-card-section>
        <div class="row q-gutter-xs">
          ...
          <q-space />
          <div class="col-6">
            <q-toggle v-model="darkMode" color="blue-grey" style="white-space:nowrap" :dense="$store.getters.dense.input"
        ...
        <div class="row q-gutter-xs">
          ...
          <q-space />
          <div class="col-6">
            <q-btn-dropdown flat no-caps :label="language.name_l" icon="g_translate" :dense="$store.getters.dense.button" class="btn-setting"
        ...
        <div class="row q-gutter-xs">
          <div class="col self-center">{{$t('types.unitPrice')}}</div>
          <q-space />
          <div class="col-6">
            <q-btn-dropdown flat no-caps :label="unitPrice.name.toHtml()" icon="currency_exchange" :dense="$store.getters.dense.button"
        ...
        <div class="row q-gutter-xs q-mb-sm">
          ...
          <div class="col self-center">
            {{$moment().format($store.getters.format.date)}}
          </div>
        </div>
        <div class="row q-gutter-xs q-mb-sm">
          <div class="col self-center">{{$t('setting.formatTime')}}</div>
          <q-space />
          <div class="col-6">
          ...
          <q-space />
          <div class="col self-center">
            {{$moment().format($store.getters.format.time)}}
          </div>
        </div>
        <q-separator inset class="q-mt-md q-mb-md" />
        <div class="row q-gutter-xs q-mb-sm">
          ...
          <q-space />
          <div class="col-6">
            <q-toggle v-model="denseForm" color="blue-grey" style="white-space:nowrap" :dense="$store.getters.dense.input"
                      :class="$store.getters.darkMode?'':'q-toggle-setting'" />
          </div>
          <q-space />
          <div class="col self-center"></div>
        ...
        <div class="row q-gutter-xs q-mb-sm">
          ...
          <q-space />
          <div class="col-6">
            <q-toggle v-model="denseTable" color="blue-grey" style="white-space:nowrap" :dense="$store.getters.dense.input"
                      :class="$store.getters.darkMode?'':'q-toggle-setting'" />
          </div>
          <q-space />
          <div class="col self-center"></div>
        ...
        <div class="row q-gutter-xs q-mb-sm">
          ...
          <q-space />
          <div class="col-6">
            <q-toggle v-model="denseInput" color="blue-grey" style="white-space:nowrap" :dense="$store.getters.dense.input"
                      :class="$store.getters.darkMode?'':'q-toggle-setting'" />
          </div>
          <q-space />
          <div class="col self-center"></div>
        ...
        <div class="row q-gutter-xs q-mb-sm">
          ...
          <q-space />
          <div class="col-6">
            <q-toggle v-model="denseButton" color="blue-grey" style="white-space:nowrap" :dense="$store.getters.dense.input"
                      :class="$store.getters.darkMode?'':'q-toggle-setting'" />
          </div>
          <q-space />
          <div class="col self-center"></div>
        ...
        <div class="row q-gutter-xs q-mb-sm">
          ...
          <q-space />
          <div class="col-6">
            <q-toggle v-model="denseMenu" color="blue-grey" style="white-space:nowrap" :dense="$store.getters.dense.input"
                      :class="$store.getters.darkMode?'':'q-toggle-setting'" />
          </div>
          <q-space />
          <div class="col self-center"></div>
        ...
        <div class="row q-gutter-xs q-mb-sm">
          ...
          <q-space />
          <div class="col-6">
            <q-toggle v-model="shadowTable" color="blue-grey" style="white-space:nowrap" :dense="$store.getters.dense.input"
                      :class="$store.getters.darkMode?'':'q-toggle-setting'" />
          </div>
          <q-space />
          <div class="col self-center"></div>
...
export default defineComponent({
  ...
  setup () {
    ...
    // const settingConstant = computed(() => $store.getters['settings/constant'])
