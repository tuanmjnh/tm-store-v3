...
<script>
import { keepScanning } from "@/qrcode-reader/scanner.js";
import { thinSquare } from "@/qrcode-reader/track-func.js";
import Camera from "@/qrcode-reader/camera.js";
import CommonAPI from "./CommonAPI.vue";
import Worker from "@/qrcode-reader/jsqr.js";
// import Worker from "@/qrcode-reader/worker.js";
