...
export default defineComponent({
  ...
  setup () {
    ...
    const onFetch = (opt) => {
      ...
      return $store.dispatch('store/importGet', opt.pagination).then(x => {
    ...
    return {
      rows, selected, categories, pagination, isDialogAdd, isDialogDetails, isDialogTouchHold, refScrollTarget, refListTarget, isFilter,
