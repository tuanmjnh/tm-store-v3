<template>
  <q-card>
    <q-toolbar>
      ...
      <q-btn v-if="!result&&rows&&rows.length" type="submit" flat color="blue" icon="backup" :loading="isLoading"
             @click.prevent="onSubmit" />
      <q-btn v-if="rows&&rows.length" type="submit" flat color="blue-grey-4" icon="restart_alt" :loading="isLoading"
