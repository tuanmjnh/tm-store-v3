export default {
  ...
  warehouse: {
    ...
    prices: 'Total price',
    totalize: 'Totalize',
    orderAdd: 'Create an order',
    totalbill: 'Total bill',
    exportConfirm: 'Bạn có chắc chắn muốn tạo đơn hàng?',
    msgExportBill: 'Order creation successful!',
    msgExportVerified: 'Order confirmed!',
    msgNotQuantity: 'The number of warehouses is not enough!',
    msgBillCanceled: 'Order has been cancelled',
    msgBillConfirmed: 'Order has been confirmed',
    msgBillConfirm: 'Are you sure you want to confirm this order?',
    msgBillCancel: 'Are you sure you want to cancel this order?',
    msgBillCancelNote: 'After canceling the order, the product will be returned to the warehouse?'
  },
  report: {
