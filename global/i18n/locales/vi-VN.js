export default {
  ...
  warehouse: {
    ...
    prices: 'Tổng tiền',
    totalize: 'Tổng cộng',
    orderAdd: 'Tạo đơn hàng',
    totalbill: 'Tổng đơn hàng',
    exportConfirm: 'Bạn có chắc chắn muốn tạo đơn hàng?',
    msgExportBill: 'Tạo đơn hàng thành công!',
    msgExportVerified: 'Đã xác nhận đơn hàng!',
    msgNotQuantity: 'Số lượng kho không đủ!',
    msgBillCanceled: 'Đơn hàng đã được hủy',
    msgBillConfirmed: 'Đơn hàng đã được xác nhận',
    msgBillConfirm: 'Bạn có chắc chắn muốn xác nhận đơn hàng này?',
    msgBillCancel: 'Bạn có chắc chắn muốn hủy đơn hàng này?',
    msgBillCancelNote: 'Sau khi huỷ đơn sản phảm sẽ được hoàn trả lại kho hàng?'
  },
  report: {
